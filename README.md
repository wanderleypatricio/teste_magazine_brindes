...
1 - Para testar o sistema basta fazer o download do projeto para um local especifico do seu computador. É necessário que tenha instalado o gerenciador de pacotes chamado composer para fazer o download das dependências.
